...
import io.github.mmm.ui.tvm.widget.number.TvmLongInput;
 ...
 * @since 1.0.0
 */
public class TvmFactoryLongInput implements UiSingleWidgetFactoryNative<UiLongInput> {
