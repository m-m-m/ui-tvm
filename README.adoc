...
image:https://img.shields.io/github/license/m-m-m/ui-tvm.svg?label=License["Apache License, Version 2.0",link=https://github.com/m-m-m/ui-tvm/blob/main/LICENSE]
...
image:https://javadoc.io/badge2/io.github.m-m-m/mmm-ui-tvm-core/javadoc.svg["JavaDoc",link=https://javadoc.io/doc/io.github.m-m-m/mmm-ui-tvm-core]

The modules `mmm-ui-tvm-*` provide the implementation of the UI API for the web using http://teavm.org/[TeaVM].
